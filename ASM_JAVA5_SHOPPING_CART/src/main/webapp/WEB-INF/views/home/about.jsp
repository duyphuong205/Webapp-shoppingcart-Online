					...
					<div class="row">
							...
							<div class="least-w3layouts-text-gap">
								<div class="row">
									<div class="col-md-4 col-sm-4 news-img">
										<img src="/AssetsForUser/images/t1.jpg" alt=""
											class="image-fluid">
									</div>
									...
									<div class="mt-3 news-agile-text">
										<img src="/AssetsForUser/images/tt1.jpg" alt=""
											class="image-fluid">
										<p class="mt-3">
						...
						<div class="col-lg-6 clients-w3layouts-row">
							<div class="least-w3layouts-text-gap">
								<div class="row">
									<div class="col-md-4 col-sm-4 news-img">
										<img src="/AssetsForUser/images/t2.jpg" alt=""
											class="image-fluid">
									</div>
									<div class="col-md-8 col-sm-8 clients-says-w3layouts">
										<h4>Sam Deo</h4>
					...
					<div class="row">
						...
						<div class="col-lg-6 clients-w3layouts-row">
							<div class="least-w3layouts-text-gap">
								<div class="row">
									<div class="col-md-4 col-sm-4 news-img">
										<img src="/AssetsForUser/images/t3.jpg" alt=""
											class="image-fluid">
									</div>
									<div class="col-md-8 col-sm-8 clients-says-w3layouts">
										<h4>Sam Deo</h4>
						...
						<div class="col-lg-6 clients-w3layouts-row">
							<div class="least-w3layouts-text-gap">
								<div class="row">
									...
									<div class="mt-3 news-agile-text">
										<img src="/AssetsForUser/images/tt2.jpg" alt=""
											class="image-fluid">
										<p class="mt-3">
											<span class="fas fa-quote-left"></span> velit sagittis
											vehicula. Duis posuere ex in mollis iaculis. Suspendisse
